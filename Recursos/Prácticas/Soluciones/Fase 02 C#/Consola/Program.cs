...
namespace Consola
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Producto objProducto = new Producto("Producto A", "Descripcion del producto A.", 10, .25, .21,
                                                    new Empresa("Acme","256253225-7","Juan Perez", new DatosContacto("info@empresa.com","las heras 12544","9568574")),
                                                    new Categoria("Categoria A"), new Categoria("Subcategoria A"));
            ...
            //Empresa objProveedor = new Empresa("Acme", "30.87654321-0", "Marta González. Int. 10", "marta@acme.com", "12345678", "Pasaje Acme 1.");

            Empresa objProveedor = new Empresa("Acme", "30.87654321-0", "Marta González. Int. 10", 
                        new DatosContacto("marta@acme.com", "12345678", "Pasaje Acme 1."));
            ...
            DatosContacto datosContactoCliente = new DatosContacto("cliente@algo.com", "Calle 232 nro44", "445545");
            ClienteIndividuo objClienteIndividuo = new ClienteIndividuo("Juan", "Pérez", "10-12345678-0", datosContactoCliente);
            ...
            Empresa objClienteEmpresa = new Empresa("Emca", "30.07050301-0", "Pedro Hernández.", new DatosContacto( "pedro@emca.com", "13335373", "Los Hernández 10."));
            ...
            Vendedor objVendedor = new Vendedor("José","Mercado", "77.666.333", new DatosContacto( "jose@acme.com", "17375778", "Av. de las Capitales 1979. Piso 1"));
            ...
            itemsFactura.Add(new Item(1,"ProdcutoA",15.13M));
            itemsFactura.Add(new Item(10, "ProdcutoB", 5.10M));
            itemsFactura.Add(new Item(2, "ProdcutoC", 10));
            itemsFactura.Add(new Item(1, "ProdcutoD", 15));

            Factura objFactura = new Factura("C", "0001-00000001", DateTime.Now, "Juan Pérez", "Av. de los Pérez 1", "Resp. Insc.", "Contado"
                                        , itemsFactura, Convert.ToDecimal(15.13));
